...
from src.db.models import GeoIndicator, ImportLogs
...
class GeoIndicatorService(
    BaseService[
        GeoIndicator, client_schema.GeoIndicatorCreate, client_schema.GeoIndicatorUpdate
    ]
):
    async def get_multi(
        self,
        session: "AsyncSession",
        filters: client_schema.GeoIndicatorListRequest | None = None,
        load_options: list[Any] | None = None,
    ) -> PaginatedResponse[client_schema.GeoIndicatorResponse]:
    ...
    async def import_excel(
        ...
        validate_required_columns(records, client.geo_indicator_fields)
        ...
        await resolve_records_fields(
            session, records, client.geo_indicator_fields, self.get_id_map
        )
