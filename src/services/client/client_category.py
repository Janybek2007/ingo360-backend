...
from src.mapping.clients import client_category_mapping
...
class ClientCategoryService(
    ...
    async def get_multi(
        ...
        filters: client.ClientCategoryListRequest | None = None,
        load_options: list[Any] | None = None,
    ) -> PaginatedResponse[client.ClientCategoryResponse]:
