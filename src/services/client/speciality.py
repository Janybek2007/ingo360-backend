...
class SpecialityService(
    BaseService[
        clients.Speciality,
        client_schema.SpecialityCreate,
        client_schema.SpecialityUpdate,
    ]
):
    async def get_multi(
        self,
        session: "AsyncSession",
        filters: client_schema.SpecialityListRequest | None = None,
        load_options: list[Any] | None = None,
    ) -> PaginatedResponse[client_schema.SpecialityResponse]:
    ...
    async def import_excel(
        ...
        validate_required_columns(records, client.speciality_fields)
        ...
        await resolve_records_fields(
            session, records, client.speciality_fields, self.get_id_map
        )
