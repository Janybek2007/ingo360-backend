...
from src.schemas import geography, base_filter
from src.services import geography as geography_service
from src.db.models import Region, Settlement, District, User
...
async def bulk_insert_countries(
    ...
    await geography_service.country_service.import_excel(session, file, user_id=current_user.id)
...
async def create_region(
    ...
    return await geography_service.region_service.create(session, region, load_options=load_options)
...
async def get_regions(
    ...
    return await geography_service.region_service.get_multi(session, load_options=load_options, filters=filters)
...
async def bulk_insert_regions(
    ...
    await geography_service.region_service.import_excel(session, file, user_id=current_user.id)
...
async def get_region(
    ...
    return await geography_service.region_service.get_or_404(session, region_id, load_options=load_options)
...
async def update_region(
    ...
    return await geography_service.region_service.update(session, region_id, region, load_options=load_options)
...
async def create_settlement(
    ...
    load_options = [
        joinedload(Settlement.region)
    ]
    return await geography_service.settlement_service.create(session, settlement, load_options=load_options)
...
async def get_settlements(
    ...
    return await geography_service.settlement_service.get_multi(session, load_options=load_options, filters=filters)
...
async def bulk_insert_settlements(
    ...
    await geography_service.settlement_service.import_excel(session, file, user_id=current_user.id)
...
async def get_settlement(
    ...
    return await geography_service.settlement_service.get_or_404(session, settlement_id, load_options=load_options)


@router.patch('/settlements/{settlement_id}', response_model=geography.SettlementResponse)
async def update_settlement(
    ...
    return await geography_service.settlement_service.update(session, settlement_id, settlement, load_options=load_options)
...
async def create_district(
    ...
    return await geography_service.district_service.create(session, district, load_options=load_options)
...
async def get_districts(
    ...
    return await geography_service.district_service.get_multi(session, load_options=load_options, filters=filters)
...
async def bulk_insert_districts(
    ...
    await geography_service.district_service.import_excel(session, file, user_id=current_user.id)
...
async def get_district(
    ...
    return await geography_service.district_service.get_or_404(session, district_id, load_options=load_options)
...
async def update_district(
    ...
    return await geography_service.district_service.update(session, district_id, district, load_options=load_options)
